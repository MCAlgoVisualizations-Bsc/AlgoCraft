...
public final class Main {
    ...
    private static void registerSortingAlgo() {
        var integerCollection1 = new SortingContext<Integer>(new ArrayList<>(Arrays.asList(3, 7, 8, 1, 6, 4, 9, 5, 2)), new ArrayList<>());

        var integerCollection2 =new SortingContext<Integer>( new ArrayList<>(Arrays.asList(8, 3, 1)), new ArrayList<>());


        Consumer<List<Integer>> builder = SortingContext::new;


        var sortedStringCollection = new SortingContext<String>(new ArrayList<>(Arrays.asList("a", "b", "c")), new ArrayList<>());
        ...
        algo.registerAlgorithm(
                Algorithm.build(ctx -> ctx
                        ...
                        .withContext(integerCollection1)
        ...
        algo.registerAlgorithm(
                Algorithm.build(ctx -> ctx
                        ...
                        .withContext(integerCollection2)
        ...
        algo.registerAlgorithm(
                Algorithm.build(ctx -> ctx
                        ...
                        .withContext(sortedStringCollection)
                        .positioning(new FloatingLinearLayout(), MapConstants.INSERTION_INTS_PLACEMENT)
                        .onEvent(Compare.class, new CompareHandler())
                        .onEvent(Swap.class, new SwapHandler())
                        .withScene(DefaultScene::new)
